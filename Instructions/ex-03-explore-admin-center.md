...
1. Open **Copilot Service admin center** from the application selector.
...
1. Select **Update user attributes**, then select **Update queues**.
...
1. From the application selector at the top of the page, select **Copilot Service workspace**.
...
1. Review the main areas of the workspace:
   ...
   - **Productivity pane** (right side) — tools such as knowledge search, email drafting, and Copilot assistance
